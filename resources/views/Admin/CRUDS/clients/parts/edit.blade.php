...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('clients.update',$row->id)}}">
    ...
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="email" required type="email" class="form-control form-control-solid" name="email" value="{{$row->email}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="website" required type="text" class="form-control form-control-solid" name="website" value="{{$row->website}}"/>
        </div>
