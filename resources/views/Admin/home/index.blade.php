        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
            <a href="{{route('admins.index')}}" class="text-center bg-white d-block  rounded-3 mb-3">
                <p class="text-uppercase fw-bold text-white text-truncate rounded-3 bg-primary p-2 mb-0">
                   Admins </p>
                <h2 class="py-4 mb-0 text-primary"><span class="counter-value" data-target="{{\App\Models\Admin::count()}}">0</span>
                </h2>
            </a>
        </div><!-- end col -->
        <div class="col-xl-3 col-lg-4 col-sm-6">
            <a href="{{route('clients.index')}}" class="text-center bg-white d-block  rounded-3 mb-3">
                <p class="text-uppercase fw-bold text-white text-truncate rounded-3 bg-warning p-2 mb-0">
                   Clients </p>
                <h2 class="py-4 mb-0 text-warning"><span class="counter-value" data-target="{{\App\Models\Client::count()}}">0</span>
                </h2>
            </a>
        </div><!-- end col -->

        <div class="col-xl-3 col-lg-4 col-sm-6">
            <a  href="{{route('countries.index')}}" class="text-center bg-white d-block  rounded-3 mb-3">
                ...
                <h2 class="py-4 mb-0 text-info"><span class="counter-value"
                                                      data-target="{{\App\Models\Area::where('from_id',null)->count()}}">0</span>
                    <span class="fs-5 text-muted">  </span>
                </h2>
            </a>
        </div><!-- end col -->
        <div class="col-xl-3 col-lg-4 col-sm-6">
            <a href="{{route('provinces.index')}}" class="text-center bg-white d-block  rounded-3 mb-3">
